...
router.post('/registerUser', function (req, res) {
	...
	User.getUserByUsername(username, function (err, user) {
		...
		if (user) {
			...
			req.checkBody('password', 'Password must be at least six characters and must contain at least one number, one capital letter, and one lower case letter.  Cannot contain a special character.')
				.isLength({min: 6})
